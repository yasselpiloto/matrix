...
class AsyncMessageConsumer(object):
    ...
    def __init__(self, host, exchange_name, exchange_type, routing_key, queue_name):
        ...
        self._message_consumer_callback = None
    ...
    def connect(self):
        ...
        """
        LOGGER.debug('Connecting to %s, %s, %s, %s' % (self._host, self._exchange_name,
                                                       self._routing_key, self._queue_name))
        return pika.SelectConnection(pika.ConnectionParameters(host=self._host),
    ...
    def on_message(self, unused_channel, basic_deliver, properties, body):
        ...
        if self._message_consumer_callback is not None:
            self._message_consumer_callback(body)
    ...
    def register_message_consumer_callback(self, callback_method):
        """Register the call back method to the message consumer
        Args:
        ...
        """
        LOGGER.debug('Message consumer callback registered')
        self._message_consumer_callback = callback_method
